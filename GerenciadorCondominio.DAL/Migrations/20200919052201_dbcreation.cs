        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFirstAccess = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourcesHistories", x => x.ResourceHistoryId);
                    table.ForeignKey(
                        name: "FK_ResourcesHistories_Months_MonthId",
                        column: x => x.MonthId,
                        principalTable: "Months",
                        principalColumn: "MonthId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "EdificeServices",
                columns: table => new
                {
                    EdificeServiceId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiceId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EdificeServices", x => x.EdificeServiceId);
                    table.ForeignKey(
                        name: "FK_EdificeServices_Services_ServiceId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "65ef245a-4ff2-472e-90c6-b602c72a2562", "1f9a5baf-0f9a-47fd-9179-4e0c1ba0ff54", "building resident", "Resident", "RESIDENT" },
                    { "60dcfe0c-642b-4f98-9163-7f16ed30616e", "0fc5109c-bfa9-49aa-863c-aa72f65b77aa", "building SYNDIC", "syndic", "SYNDIC" },
                    { "aab38feb-575b-4e8b-b374-726397e4491b", "214a7586-8146-4d90-a5b4-5844b48b5190", "building Administrator", "Administrator", "ADMINISTRATOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EdificeServices_ServiceId",
                table: "EdificeServices",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourcesHistories_MonthId",
                table: "ResourcesHistories",
                column: "MonthId");
